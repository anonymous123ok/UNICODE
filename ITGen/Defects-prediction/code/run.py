...
def main():
    ...
    args.model_name_or_path = '/workspace/attack-pretrain-models-of-code-main/CodeXGLUE/codebert-base'
    args.config_name = '/workspace/attack-pretrain-models-of-code-main/CodeXGLUE/codebert-base'
    args.tokenizer_name = '/workspace/attack-pretrain-models-of-code-main/CodeXGLUE/codebert-base'
