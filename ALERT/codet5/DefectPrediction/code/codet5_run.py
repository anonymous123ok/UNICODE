...
from codet5_model import CodeT5
...
def train(args, train_dataset, model, tokenizer, pool):
    ...
    # model.resize_token_embeddings(len(tokenizer)) #  注释掉？
...
def main():
    ...
    args.model_name_or_path = '/workspace/attack-pretrain-models-of-code-main/CodeXGLUE/codet5-base-multi-sum'
    args.config_name = '/workspace/attack-pretrain-models-of-code-main/CodeXGLUE/codet5-base-multi-sum'
    args.tokenizer_name = '/workspace/attack-pretrain-models-of-code-main/CodeXGLUE/codet5-base-multi-sum'
