...
from lsr_codet5_model import CodeT5
...
def main():
    ...
    codebert_mlm = RobertaForMaskedLM.from_pretrained('/workspace/attack-pretrain-models-of-code-main/CodeXGLUE/codebert-base-mlm')
    tokenizer_mlm = RobertaTokenizer.from_pretrained('/workspace/attack-pretrain-models-of-code-main/CodeXGLUE/codebert-base-mlm')
    ...
    with open(codes_file_path) as rf:
        for line in rf:
            ...
            #print(f"Length of source_codes: {len(source_codes)}")
            #print(f"Length of substs: {len(substs)}")
