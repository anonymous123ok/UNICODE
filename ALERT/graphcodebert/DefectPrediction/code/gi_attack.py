...
def main():
    ...
    checkpoint_prefix = 'graphcodebert_model.bin'
    output_dir = os.path.join(args.output_dir, '{}'.format(checkpoint_prefix))
    #print("注意记得修改下面这个模型的路径(by lsr)：\n\n\n\n\n")
    #output_dir = "../../../lsr_CodeT5/AuthorshipAttribution/code/saved_models/original/graphcodebert_model.bin"#这里需要改一下
