...
class CrossDomainAttacker():
    ...
    #     new_feature = self.convert_code_to_features(temp_code, tokenizer_tgt, true_label, args).input_ids
    ...
    def get_importance_score(self, args, example, tokenizer, code, words_list: list, sub_words: list, variable_names: list, model_type='classification', target_example=None):
        '''
    ...
    def greedy_attack(self, example, code, subs, target_example=None):
        ...
        orig_identifiers, orig_code_tokens = get_identifiers(code, 'c')
