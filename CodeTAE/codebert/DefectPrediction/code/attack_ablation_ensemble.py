...
def main():
    ...
    try:
        ...
        config = config_class.from_pretrained('microsoft/codebert-base/config.json')
    ...
    if args.model_name_or_path:
        try:
            ...
            model_tgt = model_class.from_pretrained('microsoft/codebert-base')
    else:
    ...
    assert (len(source_codes) == len(eval_dataset) == len(substs) == len(substs_2))
    #print("先试试能不能跑，assert那句被注释掉了")
    ...
    # with open('./adv_codebert_ensemble.txt', 'w') as f:
