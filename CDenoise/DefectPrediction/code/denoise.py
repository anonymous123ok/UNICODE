...
def evaluate(args, mlm_model, mlm_tokenizer, original_model, original_tokenizer, eval_when_training=False):
    ...
    # ans = results['repair'] / all_num
    ans = (results['repair'] + not_clean_but_right) / all_num
...
def main():
    ...
    args.eval_data_file = (
            '../dataset/All_vars/%s/%s/mlm_%s_test_all.txt' % (args.attack, args.model_name, args.model_name))
    args.block_size = 512
    args.seed = 123456
