...
def main():
    ...
    ## Required parameters
    parser.add_argument("--eval_data_file", default='../dir', type=str,
    ...
    print("=======注意这里加载的权重是哪个，别加错了=====", flush=True)
    outputdir = "../model/{}/checkpoint-best-f1/{}_{}_model.bin".format(args.model_type, args.model_type,
                                                                         args.save_name)
    ...
    if args.model_type == 'codebert':
        eval_dataset = inf_CodeBertTextDataset(tokenizer, args, args.eval_data_file)
    elif args.model_type == 'graphcodebert':
        eval_dataset = inf_GraphCodeBertTextDataset(tokenizer, args, args.eval_data_file)
    elif args.model_type == 'codet5' or args.model_type == 'codet5p':
        eval_dataset = inf_CodeT5TextDataset(tokenizer, args, args.eval_data_file)
