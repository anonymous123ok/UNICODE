...
from model import (CodeBERTnoise,CodeBERT_twoContact,CodeT5noise,CodeT5_twoContact)
cpu_cont = 16
...
def main():
    ...
    output_dir_single = '../model/{}/checkpoint-best-f1/{}_{}_model{}.bin'
    model1.load_state_dict(
        torch.load(output_dir_single.format(args.model_type, args.model_type, args.save_name, str(1))))
    logger.info(output_dir_single.format(args.model_type, args.model_type, args.save_name, str(1)))
    model1.to(args.device)
    model2.load_state_dict(
        torch.load(output_dir_single.format(args.model_type, args.model_type, args.save_name, str(2))))
    model2.to(args.device)
    logger.info("Training/evaluation parameters %s", args)
    logger.info(output_dir_single.format(args.model_type, args.model_type, args.save_name, str(2)))
