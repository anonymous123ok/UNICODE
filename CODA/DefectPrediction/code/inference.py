...
def main():
    ...
    args.output_dir = './C-defec/%s_shilihua_ori' % args.model_name
    ...
    attacker = infrence_Attacker(args, model, tokenizer, tokenizer_mlm, codebert_mlm, fasttext_model, generated_substitutions)
    source_codes = []
