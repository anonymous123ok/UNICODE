...
class Attacker():
    ...
    def attack(self, example, code_pair):
        ...
        # print("orig_label == true_label == ",orig_label)
        print("In code1 variable_names1: ", variable_names1)
        print("In code1 function_names1: ", function_names1)
        ...
        for i in np.random.choice(self.substitutions[str(topn_label)], size=len(self.substitutions[str(topn_label)]),
            ...
            if len(random_subs) >= NUMBER_1:
                break
        substituions = []
        ori_embeddings1 = get_embeddings(code1, variable_names1 + function_names1, self.tokenizer_mlm,
                                         self.codebert_mlm)
        ...
        for sub in random_subs:
            ...
            if self.args.model_name in ['codebert']:
                ...
                embeddings1 = np.load(
                    '../dataset/codet5_all_subs/%s_%s_%s.npy' % (sub['label'], embeddings_index, '1'))
